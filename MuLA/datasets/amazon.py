...
class Amazon(InMemoryDataset):
    ...
    def raw_dir(self) -> str:
        if self.name == 'computers':
            return osp.join(self.root, 'Computers', 'raw')
        elif self.name == 'photo':
            return osp.join(self.root, 'Photo', 'raw')
        else:
    ...
    def processed_dir(self) -> str:
        if self.name == 'computers':
            return osp.join(self.root, 'Computers', 'processed')
        elif self.name == 'photo':
            return osp.join(self.root, 'Photo', 'processed')
        else:
